...
ggsave(filename = "figures/REV_MIN_fig3a_simulation_efficiencies.png", plot = p,
...
ggsave(filename = "figures/REV_MIN_fig3b_simulation_efficiencies_sampling.png", plot = p,
        width = plot_width, height = plot_height, scale = 1.2, dpi = 300, units = unit, device='png')
...
ggsave(filename = "figures/REV_MIN_fig4_simulation_efficiencies_bnp.png", plot = p,
...
ggsave(filename = "figures/REV_MIN_fig5_data_efficiencies.png", plot = p,
...
ggsave(filename = "figures/REV_MIN_fig5b_data_efficiencies_bnp.png", plot = p,
