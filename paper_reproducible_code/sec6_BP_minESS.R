...
ggsave(filename = "figures/REV_MINESS_fig3a_simulation_efficiencies.png", plot = p,
...
multimodal$ESS_second2 <- multimodal$essCodaItemsAbility/multimodal$samplingTime
...
p <-  ggplot(dfParametricEffSampling,  aes_string(x = "Strategy", y= "ESS", fill = "Strategy")) +
      ...
      facet_wrap(~ Simulation, ncol=3, scales='fixed') +
      ylab("minESS/second (sampling time)") + xlab("") + 
      theme(legend.position = "none") +
      coord_flip() +
...
ggsave(filename = "figures/REV_MINESS_fig3b_simulation_efficiencies_sampling.png", plot = p,
        width = plot_width, height = plot_height, scale = 1.2, dpi = 300, units = unit, device='png')
...
ggsave(filename = "figures/REV_MINESS_fig4_simulation_efficiencies_bnp.png", plot = p,
...
paraTimss3PL$ESS_second <- paraTimss3PL$essCodaItemsAbility/paraTimss3PL$runningTime
...
## Remove Stan results because of variability in the minESS
...
ggsave(filename = "figures/REV_MINESS_fig5_data_efficiencies.png", plot = p,
...
bnpTimss3PL$ESS_second <- bnpTimss3PL$essCodaItemsAbility/bnpTimss3PL$runningTime
...
ggsave(filename = "figures/REV_MINESS_fig5b_data_efficiencies_bnp.png", plot = p,
